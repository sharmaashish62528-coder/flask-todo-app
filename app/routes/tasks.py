# want to add new tasks , delete the tasks , view 
...
def add_task():
    ...
    if title:
         ...
         db.session.add(new_task)  #This tells SQLAlchemy: I want to insert this new task into the database.
         db.session.commit()
         flash('Task added successfuly', 'success')
